...
define(["jquery", "gl-matrix", "util", "program", "shaders", "scene_node", 
    ...
    var Scene = function(gl) {
       ...
       // create WebGL program for phong illumination 
        ...
        var daytex = new texture.Texture2D(gl,"textures/earth_month04.jpg");
		var nighttex = new texture.Texture2D(gl,"textures/earth_at_night_2048.jpg");
		var barytex = new texture.Texture2D(gl, "textures/earth_bathymetry_4096.jpg");
		var cloudtex = new texture.Texture2D(gl, "textures/earth_clouds_2048.jpg");
        ...
        texture.onAllTexturesLoaded( (function() { 
            ...
            _scene.programs.planet.setTexture("daylightTexture",0,daytex);
            _scene.programs.planet.setTexture("nightTexture",1,nighttex);
            _scene.programs.planet.setTexture("baryTexture", 2, barytex);
    ...
    Scene.prototype.draw = function() {
        ...
        // showhide certain parts of the scene            
        this.ringNode.visible = this.drawOptions["Show Ring"];
        this.planetNode.visible = this.drawOptions["Show Planet"];
        
               
        var debugMode = this.drawOptions["Debug"];
	    this.programs.planet.setUniform("debugMode", "bool", debugMode);
	   
        var dayTime = this.drawOptions["DayTime Texture"];
        this.programs.planet.setUniform("dayTime", "bool", dayTime);
       
        var nightTime = this.drawOptions["NightLights"];
        this.programs.planet.setUniform("nightTime", "bool", nightTime);
       
        var redGreen = this.drawOptions["RedGreen"];
        this.programs.planet.setUniform("redGreen", "bool", redGreen);
       
        var glossMap = this.drawOptions["GlossMap"];
        this.programs.planet.setUniform("glossMap", "bool", glossMap);
	   
	    var cloudMode = this.drawOptions["Clouds"];
	    this.programs.planet.setUniform("cloudMode", "bool", cloudMode);
